...
import com.damon.bean.Student;
import com.damon.service.StudentService;
import com.damon.util.Page;
...
public class StudentController {
    ...
    public String addStudent(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            birthday = (Date) simpleDateFormat.parse(request.getParameter("birthday"));
